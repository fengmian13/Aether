...
public class ChatSessionServiceImpl implements ChatSessionService {
	 ...
	 */
	@Override
	public ChatSession getChatSessionByUserIdAndContactId(String userId, String contactId) {
		return this.chatSessionMapper.selectByUserIdAndContactId(userId, contactId);
	}
	 ...
	 */
	@Override
	public Integer updateChatSessionByUserIdAndContactId(ChatSession bean, String userId, String contactId) {
		return this.chatSessionMapper.updateByUserIdAndContactId(bean, userId, contactId);
	}
	 ...
	 */
	@Override
	public Integer deleteChatSessionByUserIdAndContactId(String userId, String contactId) {
		return this.chatSessionMapper.deleteByUserIdAndContactId(userId, contactId);
	}
}